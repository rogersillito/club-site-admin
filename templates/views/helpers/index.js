...
var cloudinaryUrlLimit = _.template(CLOUDINARY_HOST +
...
module.exports = function() {
  ...
  _helpers.categoryList = function(categories, options) {
    var autolink = _.isString(options.hash.autolink) && options.hash.autolink ===
      "false" ? false : true,
  ...
  // Direct support of the cloudinary.url method from Handlears (see
